...
rem output binary, which is called "BOOTAA64.EFI"
rem
...
rem Windows linker (and compatibles) also generate import library files with shared libraries.
rem Don't need it for this purpose, and there doesn't seem to be a way to disable generation of import library files.
